...
const handleLogin = async () => {
  ...
  if (isValid) {
      ...
      try {
          ...
          toast.add({ severity: 'error', summary: 'Erreur', detail: 'Échec de la connexion', life: 3000 })
...
<template>
  <div class="flex align-items-center justify-content-center min-h-screen bg-gray-100">
      <div class="surface-card p-4 shadow-2 border-round w-full max-w-lg">
          <h1 class="text-center text-primary font-bold mb-4 text-2xl">Pantheonze</h1>
          
          <TabView v-model:activeIndex="activeTab">
              <TabPanel header="Connexion" :value="0">
                  <form @submit.prevent="handleLogin" class="flex flex-column gap-3">
                      <div class="flex flex-column gap-2">
                          ...
                          />
                          <small class="p-error" v-if="loginForm.errors.email">{{ loginForm.errors.email }}</small>
                      </div>
                      ...
                      <div class="flex flex-column gap-2">
                          ...
                          />
                          <small class="p-error" v-if="loginForm.errors.password">{{ loginForm.errors.password }}</small>
                      </div>

                      <div class="flex align-items-center justify-content-between">
                          <div class="flex align-items-center">
                              <Checkbox v-model="loginForm.rememberMe" :binary="true" id="rememberMe" />
                              <label for="rememberMe" class="ml-2">Se souvenir de moi</label>
                          </div>
                          <Button 
              ...
              <TabPanel header="Inscription" :value="1">
                  <form @submit.prevent="handleRegister" class="flex flex-column gap-3">
                          ...
                          <div class="col-12 md:col-6">
                              <div class="flex flex-column gap-2">
                                  ...
                                  <InputText
                                      ...
                                      placeholder="Jean"
                                  />
                                  <small class="p-error" v-if="registerForm.errors.firstName">{{ registerForm.errors.firstName }}</small>
                              </div>
                          </div>
                          ...
                          <div class="col-12 md:col-6">
                              <div class="flex flex-column gap-2">
                                  ...
                                  <InputText
                                      ...
                                      placeholder="Dupont"
                                  />
                                  <small class="p-error" v-if="registerForm.errors.lastName">{{ registerForm.errors.lastName }}</small>
                              </div>
                          </div>
                      </div>
                      ...
                      <div class="flex flex-column gap-2">
                          ...
                          <InputText
                              ...
                              placeholder="exemple@email.com"
                          />
                          <small class="p-error" v-if="registerForm.errors.email">{{ registerForm.errors.email }}</small>
                      </div>
                      ...
                      <div class="flex flex-column gap-2">
                          ...
                          />
                          <small class="p-error" v-if="registerForm.errors.password">{{ registerForm.errors.password }}</small>
                      </div>
                      ...
                      <div class="flex flex-column gap-2">
                          ...
                          />
                          <small class="p-error" v-if="registerForm.errors.confirmPassword">{{ registerForm.errors.confirmPassword }}</small>
                      </div>
