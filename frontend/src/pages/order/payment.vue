    ...
    <div class="surface-card p-4 border-round">
      ...
      <div class="grid">
        ...
        <div class="col-12 lg:col-8">
          ...
          <!-- Formulaire carte bancaire -->
          <div v-if="paymentMethod === 'card'" class="surface-ground p-4 border-round">
          ...
          <!-- PayPal -->
          <div v-else-if="paymentMethod === 'paypal'" class="surface-ground p-4 border-round text-center">
        ...
        <div class="col-12 lg:col-4">
          <div class="surface-card p-4 border-round border-1 surface-border sticky" style="top: 1rem">
