  ...
  <div class="min-h-screen flex flex-column surface-ground">
      ...
      <div class="w-full md:w-9 mx-auto">
        ...
        >
          ...
          <div class="flex align-items-center gap-2">
            ...
            >
              <i
                class="pi pi-shopping-cart text-900 text-xl hover:text-primary"
              ></i>
            </Button>
    ...
    <footer class="surface-section border-top-1 surface-border">
      <div class="w-full md:w-9 mx-auto py-4">
        <div
          class="flex flex-column md:flex-row justify-content-between align-items-start"
        >
          <!-- Contact -->
        ...
        <div
          class="text-center mt-5 text-500 flex align-items-center justify-content-center gap-2 border-top-1 surface-border pt-3"
        >
